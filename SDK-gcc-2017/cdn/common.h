...
#define MIN_VALUE 0.08              //用来界定选择服务器,serverID 0.011
#define MIN_VALUE_ZERO 0.05        //用来界定所有备选服务器,serverCandidate 0.005
#define MIN_VALUE_ZERO_DOWN 0.008     //界定线性规划包含的可能服务器,serverPossible 0.0005
